...
#ifndef OM_MENU_ROWS
    #define OM_MENU_ROWS    3
#endif

#ifndef OM_MENU_COLS
    #define OM_MENU_COLS    19
#endif
...
enum  { MENU_ANALOG, MENU_DIGITAL, MENU_KEYPAD };
...
public:
    ...
    void setKeypadInput(Keypad* myKpd, MenuKeyMap* keyMap);
