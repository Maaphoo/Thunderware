...
{calibrateStr, 0, 36, NULL, 0, Menu::TITLE, NULL},
{auxiliaryStr, 0, 122, NULL, 0, Menu::TITLE, NULL},
...
{zone1InitialSetTempStr, 0, -1, &configuration.profile.zone1InitialSetTemp, 0, Menu::DOUBLE, NULL},
{zone2InitialSetTempStr, 0, -1, &configuration.profile.zone2InitialSetTemp, 0, Menu::DOUBLE, NULL},
{zone3InitialSetTempStr, 0, -1, &configuration.profile.zone3InitialSetTemp, 0, Menu::DOUBLE, NULL},
{zone4InitialSetTempStr, 0, -1, &configuration.profile.zone4InitialSetTemp, 0, Menu::DOUBLE, NULL},
...
{starveFeederConfigStr, 2, 42, NULL, 0, Menu::TITLE, NULL},
{augerConfigStr, 2, 66, NULL, 0, Menu::TITLE, NULL},
{heaterConfigStr, 2, 72, NULL, 0, Menu::TITLE, NULL},
{outfeedConfigStr, 2, 103, NULL, 0, Menu::TITLE, NULL},
{spoolerConfigStr, 2, 113, NULL, 0, Menu::TITLE, NULL},
{homeStarveFeederStr, 37, -1, NULL, 0, Menu::ACTION, &homeStarveFeeder},
{dumpStr, 37, -1, NULL, 0, Menu::ACTION, &dump},
{feedStr, 37, -1, &feedMode, 0, Menu::STRING_LOCKED, &feed},
{sendCyclesStr, 37, -1, NULL, 0, Menu::ACTION, &sendCyclesToStarveFeeder},
{cyclesToSendToStarveFeederStr, 37, -1, &cyclesToSendToStarveFeeder, 0, Menu::INT, NULL},
{sendTimeStr, 37, -1, NULL, 0, Menu::ACTION, &sendTimeToStarveFeeder},
{timeToSendToStarveFeederStr, 37, -1, &timeToSendToStarveFeeder, 0, Menu::INT, NULL},
{gramsPerMinStr, 37, -1, &configuration.profile.gramsPerMin, 2, Menu::FLOAT, NULL},
{stopStr, 37, -1, NULL, 0, Menu::ACTION, &stopStarveFeeder},
{starveFeederSlaveAddressStr, 37, -1, &configuration.physical.starveFeederSlaveAddress, 0, Menu::INT, NULL},
{starveFeederLumpMassStr, 37, -1, &configuration.physical.starveFeederLumpMass, 2, Menu::FLOAT, NULL},
{starveFeederHomePositionStr, 37, -1, &configuration.physical.starveFeederHomePosition, 0, Menu::INT, NULL},
{starveFeederDumpPositionStr, 37, -1, &configuration.physical.starveFeederDumpPosition, 0, Menu::INT, NULL},
{starveFeederStepDelayStr, 37, -1, &configuration.physical.starveFeederStepDelay, 0, Menu::INT, NULL},
{starveFeederHomingStepDelayStr, 37, -1, &configuration.physical.starveFeederHomingStepDelay, 0, Menu::INT, NULL},
{starveFeederOverRotationStr, 37, -1, &configuration.physical.starveFeederOverRotation, 0, Menu::INT, NULL},
{starveFeederDirectionStr, 37, -1, &configuration.physical.starveFeederDirection, 0, Menu::BOOLEAN, NULL},
{starveFeederVibDutyCycleStr, 37, -1, &configuration.physical.starveFeederVibDutyCycle, 0, Menu::INT, NULL},
{starveFeederStartupDutyCycleStr, 37, -1, &configuration.physical.starveFeederStartupDutyCycle, 0, Menu::INT, NULL},
{starveFeederMaxDutyCycleStr, 37, -1, &configuration.physical.starveFeederMaxDutyCycle, 0, Menu::INT, NULL},
{starveFeederMinFillTimeStr, 37, -1, &configuration.physical.starveFeederMinFillTime, 0, Menu::INT, NULL},
{starveFeederMaxFillTimeStr, 37, -1, &configuration.physical.starveFeederMaxFillTime, 0, Menu::INT, NULL},
{starveFeederStartupTimeStr, 37, -1, &configuration.physical.starveFeederStartupTime, 0, Menu::INT, NULL},
{starveFeederDebounceTimeStr, 37, -1, &configuration.physical.starveFeederDebounceTime, 0, Menu::INT, NULL},
{testAugerStr, 38, -1, NULL, 0, Menu::ACTION, &testAuger},
{augerPinSetStr, 38, -1, &configuration.physical.augerPinSet, 0, Menu::INT, NULL},
{augerStepModeStr, 38, -1, &configuration.physical.augerStepMode, 0, Menu::INT, NULL},
{augerDirectionStr, 38, -1, &configuration.physical.augerDirection, 0, Menu::BOOLEAN, NULL},
{augerEnableStr, 38, -1, &configuration.physical.augerEnable, 0, Menu::BOOLEAN, NULL},
{augerGearRatioStr, 38, -1, &configuration.physical.augerGearRatio, 2, Menu::FLOAT, NULL},
{heaterStateStr, 39, -1, &heaterState, 0, Menu::STRING_LOCKED, &toggleHeaterState},
{zone1TempStr, 39, -1, &zone1Temp, 1, Menu::DOUBLE_LOCKED, NULL},
{zone2TempStr, 39, -1, &zone2Temp, 1, Menu::DOUBLE_LOCKED, NULL},
{zone3TempStr, 39, -1, &zone3Temp, 1, Menu::DOUBLE_LOCKED, NULL},
{zone4TempStr, 39, -1, &zone4Temp, 1, Menu::DOUBLE_LOCKED, NULL},
{zone1SetTempStr, 39, -1, &configuration.physical.zone1.setTemp, 0, Menu::DOUBLE, NULL},
{zone2SetTempStr, 39, -1, &configuration.physical.zone2.setTemp, 0, Menu::DOUBLE, NULL},
{zone3SetTempStr, 39, -1, &configuration.physical.zone3.setTemp, 0, Menu::DOUBLE, NULL},
{zone4SetTempStr, 39, -1, &configuration.physical.zone4.setTemp, 0, Menu::DOUBLE, NULL},
{zone1TimeBaseStr, 39, -1, &configuration.physical.zone1.timeBase, 0, Menu::INT, NULL},
{zone1MaxDutyCycleStr, 39, -1, &configuration.physical.zone1.maxDutyCycle, 0, Menu::DOUBLE, NULL},
{zone1MinDutyCycleStr, 39, -1, &configuration.physical.zone1.minDutyCycle, 0, Menu::DOUBLE, NULL},
{zone1KpStr, 39, -1, &configuration.physical.zone1.Kp, 2, Menu::DOUBLE, NULL},
{zone1KiStr, 39, -1, &configuration.physical.zone1.Ki, 2, Menu::DOUBLE, NULL},
{zone1KdStr, 39, -1, &configuration.physical.zone1.Kd, 2, Menu::DOUBLE, NULL},
{zone2TimeBaseStr, 39, -1, &configuration.physical.zone2.timeBase, 0, Menu::INT, NULL},
{zone2MaxDutyCycleStr, 39, -1, &configuration.physical.zone2.maxDutyCycle, 0, Menu::DOUBLE, NULL},
{zone2MinDutyCycleStr, 39, -1, &configuration.physical.zone2.minDutyCycle, 0, Menu::DOUBLE, NULL},
{zone2KpStr, 39, -1, &configuration.physical.zone2.Kp, 2, Menu::DOUBLE, NULL},
{zone2KiStr, 39, -1, &configuration.physical.zone2.Ki, 2, Menu::DOUBLE, NULL},
{zone2KdStr, 39, -1, &configuration.physical.zone2.Kd, 2, Menu::DOUBLE, NULL},
{zone3MaxDutyCycleStr, 39, -1, &configuration.physical.zone3.maxDutyCycle, 0, Menu::DOUBLE, NULL},
{zone3MinDutyCycleStr, 39, -1, &configuration.physical.zone3.minDutyCycle, 0, Menu::DOUBLE, NULL},
{zone3KpStr, 39, -1, &configuration.physical.zone3.Kp, 2, Menu::DOUBLE, NULL},
{zone3KiStr, 39, -1, &configuration.physical.zone3.Ki, 2, Menu::DOUBLE, NULL},
{zone3KdStr, 39, -1, &configuration.physical.zone3.Kd, 2, Menu::DOUBLE, NULL},
{zone4MaxDutyCycleStr, 39, -1, &configuration.physical.zone4.maxDutyCycle, 0, Menu::DOUBLE, NULL},
{zone4MinDutyCycleStr, 39, -1, &configuration.physical.zone4.minDutyCycle, 0, Menu::DOUBLE, NULL},
{zone4KpStr, 39, -1, &configuration.physical.zone4.Kp, 2, Menu::DOUBLE, NULL},
{zone4KiStr, 39, -1, &configuration.physical.zone4.Ki, 2, Menu::DOUBLE, NULL},
{zone4KdStr, 39, -1, &configuration.physical.zone4.Kd, 2, Menu::DOUBLE, NULL},
{runOutfeedStr, 40, -1, &outfeedState, 0, Menu::STRING_LOCKED, &toggleOutfeedState},
{RPMStr, 40, -1, &outfeedRPM, 0, Menu::FLOAT, NULL},
{sendOneRevToOutfeedStr, 40, -1, NULL, 0, Menu::ACTION, &sendOneRevToOutfeed},
{outfeedPinSetStr, 40, -1, &configuration.physical.outfeedPinSet, 0, Menu::INT, NULL},
{outfeedStepModeStr, 40, -1, &configuration.physical.outfeedStepMode, 0, Menu::INT, NULL},
{outfeedDirectionStr, 40, -1, &configuration.physical.outfeedDirection, 0, Menu::BOOLEAN, NULL},
{outfeedEnableLogicStr, 40, -1, &configuration.physical.outfeedEnable, 0, Menu::BOOLEAN, NULL},
{outfeedRollerRadiusStr, 40, -1, &configuration.physical.outfeedRollerRadius, 2, Menu::FLOAT, NULL},
{outfeedMaxRPMStr, 40, -1, &configuration.physical.outfeedMaxRPM, 2, Menu::DOUBLE, NULL},
{outfeedMinRPMStr, 40, -1, &configuration.physical.outfeedMinRPM, 2, Menu::DOUBLE, NULL},
{testSpoolerStr, 41, -1, NULL, 0, Menu::ACTION, &testSpooler},
{spoolerPinSetStr, 41, -1, &configuration.physical.spoolerPinSet, 0, Menu::INT, NULL},
{spoolerStepModeStr, 41, -1, &configuration.physical.spoolerStepMode, 0, Menu::INT, NULL},
{spoolerDirectionStr, 41, -1, &configuration.physical.spoolerDirection, 0, Menu::BOOLEAN, NULL},
{spoolerEnableStr, 41, -1, &configuration.physical.spoolerEnable, 0, Menu::BOOLEAN, NULL},
{spoolerDiskRadiusStr, 41, -1, &configuration.physical.spoolerDiskRadius, 2, Menu::FLOAT, NULL},
{spoolerCoreRadiusStr, 41, -1, &configuration.physical.spoolerCoreRadius, 2, Menu::FLOAT, NULL},
{spoolerTraverseLengthStr, 41, -1, &configuration.physical.spoolerTraverseLength, 2, Menu::FLOAT, NULL},
{spoolerMotorRollerRadiusStr, 41, -1, &configuration.physical.spoolerMotorRollerRadius, 2, Menu::FLOAT, NULL},
