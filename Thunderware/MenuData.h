...
const char starveFeederMinDutyCycleStr[] PROGMEM = "MinDutyCycle";
...
const Menu::MenuItem mainItems[] PROGMEM =
{
	...
	{auxiliaryStr, 0, 103, NULL, 0, Menu::TITLE, NULL},
	...
	{starveFeederConfigStr, 2, 39, NULL, 0, Menu::TITLE, NULL},
	{augerConfigStr, 2, 55, NULL, 0, Menu::TITLE, NULL},
	{barrelConfigStr, 2, 61, NULL, 0, Menu::TITLE, NULL},
	{nozzleConfigStr, 2, 73, NULL, 0, Menu::TITLE, NULL},
	{outfeedConfigStr, 2, 86, NULL, 0, Menu::TITLE, NULL},
	{spoolerConfigStr, 2, 94, NULL, 0, Menu::TITLE, NULL},
	{testStarveFeederStr, 33, -1, NULL, 0, Menu::ACTION, &beginStarveFeederTest},
	...
	{starveFeederMinDutyCycleStr, 33, -1, &configuration.physical.starveFeederMinDutyCycle, 0, Menu::INT, NULL},
	...
	{testBarrelStr, 35, -1, NULL, 0, Menu::ACTION, &beginBarrelTest},
	{timeBaseStr, 35, -1, &configuration.physical.timeBase, 0, Menu::INT, NULL},
	{barrelMaxDutyCycleStr, 35, -1, &configuration.physical.barrelMax, 0, Menu::DOUBLE, NULL},
	{barrelMinDutyCycleStr, 35, -1, &configuration.physical.barrelMin, 0, Menu::DOUBLE, NULL},
	{barrelKpStr, 35, -1, &configuration.physical.barrelKp, 2, Menu::DOUBLE, NULL},
	{barrelKiStr, 35, -1, &configuration.physical.barrelKi, 2, Menu::DOUBLE, NULL},
	{barrelKdStr, 35, -1, &configuration.physical.barrelKd, 2, Menu::DOUBLE, NULL},
	{barrelTRNomStr, 35, -1, &configuration.physical.barrelTRNom, 0, Menu::UNSIGNED_LONG, NULL},
	{barrelTTNomStr, 35, -1, &configuration.physical.barrelTTNom, 0, Menu::INT, NULL},
	{barrelTNumSamplesStr, 35, -1, &configuration.physical.barrelTNumSamples, 0, Menu::INT, NULL},
	{barrelTBCoefficientStr, 35, -1, &configuration.physical.barrelTBCoefficient, 0, Menu::INT, NULL},
	{barrelTSeriesResistorStr, 35, -1, &configuration.physical.barrelTSeriesResistor, 0, Menu::INT, NULL},
	{testNozzleStr, 36, -1, NULL, 0, Menu::TITLE, &beginNozzleTest},
	{nozzlePinStr, 36, -1, &configuration.physical.nozzlePin, 0, Menu::INT, NULL},
	{nozzleMaxDutyCycleStr, 36, -1, &configuration.physical.nozzleMax, 0, Menu::DOUBLE, NULL},
	{nozzleMinDutyCycleStr, 36, -1, &configuration.physical.nozzleMin, 0, Menu::DOUBLE, NULL},
	{nozzleKpStr, 36, -1, &configuration.physical.nozzleKp, 2, Menu::DOUBLE, NULL},
	{nozzleKiStr, 36, -1, &configuration.physical.nozzleKi, 2, Menu::DOUBLE, NULL},
	{nozzleKdStr, 36, -1, &configuration.physical.nozzleKd, 2, Menu::DOUBLE, NULL},
	{nozzleSampleTimeStr, 36, -1, &configuration.physical.nozzleSampleTime, 0, Menu::INT, NULL},
	{nozzleTRNomStr, 36, -1, &configuration.physical.nozzleTRNom, 0, Menu::UNSIGNED_LONG, NULL},
	{nozzleTTNomStr, 36, -1, &configuration.physical.nozzleTTNom, 0, Menu::INT, NULL},
	{nozzleTNumSamplesStr, 36, -1, & configuration.physical.nozzleTNumSamples, 0, Menu::INT, NULL},
	{nozzleTBCoefficientStr, 36, -1, &configuration.physical.nozzleTBCoefficient, 0, Menu::INT, NULL},
	{nozzleTSeriesResistorStr, 36, -1,  &configuration.physical.nozzleTSeriesResistor, 0, Menu::INT, NULL},
	{testOutfeedStr, 37, -1, NULL, 0, Menu::ACTION, &testOutfeed},
	{outfeedPinSetStr, 37, -1, &configuration.physical.outfeedPinSet, 0, Menu::INT, NULL},
	{outfeedStepModeStr, 37, -1, &configuration.physical.outfeedStepMode, 0, Menu::INT, NULL},
	{outfeedDirectionStr, 37, -1, &configuration.physical.outfeedDirection, 0, Menu::BOOLEAN, NULL},
	{outfeedEnableStr, 37, -1, &configuration.physical.outfeedEnable, 0, Menu::BOOLEAN, NULL},
	{outfeedRollerRadiusStr, 37, -1, &configuration.physical.outfeedRollerRadius, 2, Menu::FLOAT, NULL},
	{outfeedMaxRPMStr, 37, -1, &configuration.physical.outfeedMaxRPM, 2, Menu::DOUBLE, NULL},
	{outfeedMinRPMStr, 37, -1, &configuration.physical.outfeedMinRPM, 2, Menu::DOUBLE, NULL},
	{testSpoolerStr, 38, -1, NULL, 0, Menu::ACTION, &testSpooler},
	{spoolerPinSetStr, 38, -1, &configuration.physical.spoolerPinSet, 0, Menu::INT, NULL},
	{spoolerStepModeStr, 38, -1, &configuration.physical.spoolerStepMode, 0, Menu::INT, NULL},
	{spoolerDirectionStr, 38, -1, &configuration.physical.spoolerDirection, 0, Menu::BOOLEAN, NULL},
	{spoolerEnableStr, 38, -1, &configuration.physical.spoolerEnable, 0, Menu::BOOLEAN, NULL},
	{spoolerDiskRadiusStr, 38, -1, &configuration.physical.spoolerDiskRadius, 2, Menu::FLOAT, NULL},
	{spoolerCoreRadiusStr, 38, -1, &configuration.physical.spoolerCoreRadius, 2, Menu::FLOAT, NULL},
	{spoolerTraverseLengthStr, 38, -1, &configuration.physical.spoolerTraverseLength, 2, Menu::FLOAT, NULL},
	{spoolerMotorRollerRadiusStr, 38, -1, &configuration.physical.spoolerMotorRollerRadius, 2, Menu::FLOAT, NULL},
...
const Menu::MenuItem starveFeederTestItems[] PROGMEM =
{
	...
	{starveFeederMinDutyCycleStr, 0, -1, &configuration.physical.starveFeederMinDutyCycle, 0, Menu::INT, NULL},
