...
const char zone3TempStr[] PROGMEM = "Zone 2 Temp";
...
{calibrateStr, 0, 30, NULL, 0, Menu::TITLE, NULL},
{auxiliaryStr, 0, 100, NULL, 0, Menu::TITLE, NULL},
...
{starveFeederConfigStr, 2, 36, NULL, 0, Menu::TITLE, NULL},
{augerConfigStr, 2, 60, NULL, 0, Menu::TITLE, NULL},
{heaterConfigStr, 2, 66, NULL, 0, Menu::TITLE, NULL},
{outfeedConfigStr, 2, 83, NULL, 0, Menu::TITLE, NULL},
{spoolerConfigStr, 2, 91, NULL, 0, Menu::TITLE, NULL},
{homeStarveFeederStr, 31, -1, NULL, 0, Menu::ACTION, &homeStarveFeeder},
{dumpStr, 31, -1, NULL, 0, Menu::ACTION, &dump},
{feedStr, 31, -1, &feedMode, 0, Menu::STRING_LOCKED, &feed},
{sendCyclesStr, 31, -1, NULL, 0, Menu::ACTION, &sendCyclesToStarveFeeder},
{cyclesToSendToStarveFeederStr, 31, -1, &cyclesToSendToStarveFeeder, 0, Menu::INT, NULL},
{sendTimeStr, 31, -1, NULL, 0, Menu::ACTION, &sendTimeToStarveFeeder},
{timeToSendToStarveFeederStr, 31, -1, &timeToSendToStarveFeeder, 0, Menu::INT, NULL},
{gramsPerMinStr, 31, -1, &configuration.profile.gramsPerMin, 2, Menu::FLOAT, NULL},
{stopStr, 31, -1, NULL, 0, Menu::ACTION, &stopStarveFeeder},
{starveFeederSlaveAddressStr, 31, -1, &configuration.physical.starveFeederSlaveAddress, 0, Menu::INT, &loadStarveFeederConfig},
{starveFeederLumpMassStr, 31, -1, &configuration.physical.starveFeederLumpMass, 2, Menu::FLOAT, &loadStarveFeederConfig},
{starveFeederHomePositionStr, 31, -1, &configuration.physical.starveFeederHomePosition, 0, Menu::INT, &loadStarveFeederConfig},
{starveFeederDumpPositionStr, 31, -1, &configuration.physical.starveFeederDumpPosition, 0, Menu::INT, &loadStarveFeederConfig},
{starveFeederStepDelayStr, 31, -1, &configuration.physical.starveFeederStepDelay, 0, Menu::INT, &loadStarveFeederConfig},
{starveFeederHomingStepDelayStr, 31, -1, &configuration.physical.starveFeederHomingStepDelay, 0, Menu::INT, &loadStarveFeederConfig},
{starveFeederOverRotationStr, 31, -1, &configuration.physical.starveFeederOverRotation, 0, Menu::INT, &loadStarveFeederConfig},
{starveFeederDirectionStr, 31, -1, &configuration.physical.starveFeederDirection, 0, Menu::BOOLEAN, &loadStarveFeederConfig},
{starveFeederVibDutyCycleStr, 31, -1, &configuration.physical.starveFeederVibDutyCycle, 0, Menu::INT, &loadStarveFeederConfig},
{starveFeederStartupDutyCycleStr, 31, -1, &configuration.physical.starveFeederStartupDutyCycle, 0, Menu::INT, &loadStarveFeederConfig},
{starveFeederMaxDutyCycleStr, 31, -1, &configuration.physical.starveFeederMaxDutyCycle, 0, Menu::INT, &loadStarveFeederConfig},
{starveFeederMinFillTimeStr, 31, -1, &configuration.physical.starveFeederMinFillTime, 0, Menu::INT, &loadStarveFeederConfig},
{starveFeederMaxFillTimeStr, 31, -1, &configuration.physical.starveFeederMaxFillTime, 0, Menu::INT, &loadStarveFeederConfig},
{starveFeederStartupTimeStr, 31, -1, &configuration.physical.starveFeederStartupTime, 0, Menu::INT, &loadStarveFeederConfig},
{starveFeederDebounceTimeStr, 31, -1, &configuration.physical.starveFeederDebounceTime, 0, Menu::INT, &loadStarveFeederConfig},
{testAugerStr, 32, -1, NULL, 0, Menu::ACTION, &testAuger},
{augerPinSetStr, 32, -1, &configuration.physical.augerPinSet, 0, Menu::INT, NULL},
{augerStepModeStr, 32, -1, &configuration.physical.augerStepMode, 0, Menu::INT, NULL},
{augerDirectionStr, 32, -1, &configuration.physical.augerDirection, 0, Menu::BOOLEAN, NULL},
{augerEnableStr, 32, -1, &configuration.physical.augerEnable, 0, Menu::BOOLEAN, NULL},
{augerGearRatioStr, 32, -1, &configuration.physical.augerGearRatio, 2, Menu::FLOAT, NULL},
{heaterStateStr, 33, -1, &heaterState, 0, Menu::ACTION, &toggleHeaterState},
{zone1TempStr, 33, -1, &zone1Temp, 1, Menu::DOUBLE_LOCKED, NULL},
{zone2TempStr, 33, -1, &zone2Temp, 1, Menu::DOUBLE_LOCKED, NULL},
{zone3TempStr, 33, -1, &zone3Temp, 1, Menu::DOUBLE_LOCKED, NULL},
{zone1SetTempStr, 33, -1, &configuration.profile.zone1SetTemp, 0, Menu::DOUBLE, NULL},
{zone2SetTempStr, 33, -1, &configuration.profile.zone2SetTemp, 0, Menu::DOUBLE, NULL},
{zone3SetTempStr, 33, -1, &configuration.profile.zone3SetTemp, 0, Menu::DOUBLE, NULL},
{zone1TimeBaseStr, 33, -1, &configuration.physical.zone1.timeBase, 0, Menu::INT, NULL},
{zone1MaxDutyCycleStr, 33, -1, &configuration.physical.zone1.maxDutyCycle, 0, Menu::DOUBLE, NULL},
{zone1MinDutyCycleStr, 33, -1, &configuration.physical.zone1.minDutyCycle, 0, Menu::DOUBLE, NULL},
{zone1KpStr, 33, -1, &configuration.physical.zone1.Kp, 2, Menu::DOUBLE, NULL},
{zone1KiStr, 33, -1, &configuration.physical.zone1.Ki, 2, Menu::DOUBLE, NULL},
{zone1KdStr, 33, -1, &configuration.physical.zone1.Kd, 2, Menu::DOUBLE, NULL},
{zone2TimeBaseStr, 33, -1, &configuration.physical.zone2.timeBase, 0, Menu::INT, NULL},
{zone2MaxDutyCycleStr, 33, -1, &configuration.physical.zone2.maxDutyCycle, 0, Menu::DOUBLE, NULL},
{zone2MinDutyCycleStr, 33, -1, &configuration.physical.zone2.minDutyCycle, 0, Menu::DOUBLE, NULL},
{zone2KpStr, 33, -1, &configuration.physical.zone2.Kp, 2, Menu::DOUBLE, NULL},
{zone2KiStr, 33, -1, &configuration.physical.zone2.Ki, 2, Menu::DOUBLE, NULL},
{zone2KdStr, 33, -1, &configuration.physical.zone2.Kd, 2, Menu::DOUBLE, NULL},
{zone3MaxDutyCycleStr, 33, -1, &configuration.physical.zone3.maxDutyCycle, 0, Menu::DOUBLE, NULL},
{zone3MinDutyCycleStr, 33, -1, &configuration.physical.zone3.minDutyCycle, 0, Menu::DOUBLE, NULL},
{zone3KpStr, 33, -1, &configuration.physical.zone3.Kp, 2, Menu::DOUBLE, NULL},
{zone3KiStr, 33, -1, &configuration.physical.zone3.Ki, 2, Menu::DOUBLE, NULL},
{zone3KdStr, 33, -1, &configuration.physical.zone3.Kd, 2, Menu::DOUBLE, NULL},
{testOutfeedStr, 34, -1, NULL, 0, Menu::ACTION, &testOutfeed},
{outfeedPinSetStr, 34, -1, &configuration.physical.outfeedPinSet, 0, Menu::INT, NULL},
{outfeedStepModeStr, 34, -1, &configuration.physical.outfeedStepMode, 0, Menu::INT, NULL},
{outfeedDirectionStr, 34, -1, &configuration.physical.outfeedDirection, 0, Menu::BOOLEAN, NULL},
{outfeedEnableStr, 34, -1, &configuration.physical.outfeedEnable, 0, Menu::BOOLEAN, NULL},
{outfeedRollerRadiusStr, 34, -1, &configuration.physical.outfeedRollerRadius, 2, Menu::FLOAT, NULL},
{outfeedMaxRPMStr, 34, -1, &configuration.physical.outfeedMaxRPM, 2, Menu::DOUBLE, NULL},
{outfeedMinRPMStr, 34, -1, &configuration.physical.outfeedMinRPM, 2, Menu::DOUBLE, NULL},
{testSpoolerStr, 35, -1, NULL, 0, Menu::ACTION, &testSpooler},
{spoolerPinSetStr, 35, -1, &configuration.physical.spoolerPinSet, 0, Menu::INT, NULL},
{spoolerStepModeStr, 35, -1, &configuration.physical.spoolerStepMode, 0, Menu::INT, NULL},
{spoolerDirectionStr, 35, -1, &configuration.physical.spoolerDirection, 0, Menu::BOOLEAN, NULL},
{spoolerEnableStr, 35, -1, &configuration.physical.spoolerEnable, 0, Menu::BOOLEAN, NULL},
{spoolerDiskRadiusStr, 35, -1, &configuration.physical.spoolerDiskRadius, 2, Menu::FLOAT, NULL},
{spoolerCoreRadiusStr, 35, -1, &configuration.physical.spoolerCoreRadius, 2, Menu::FLOAT, NULL},
{spoolerTraverseLengthStr, 35, -1, &configuration.physical.spoolerTraverseLength, 2, Menu::FLOAT, NULL},
{spoolerMotorRollerRadiusStr, 35, -1, &configuration.physical.spoolerMotorRollerRadius, 2, Menu::FLOAT, NULL},
